...
html: '<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd"><html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" style="margin:0"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"></head><body style="margin:0;">INITIAL_CONTENT</body></html>',
		...
		this.init = function (element, options) {
			...
			if (this.options.iFrameClass) {
			    ...
			    //var heightContainer = $('#div-editor-estudio').height() - 54;
			    this.editor.css({
			        height: newY.toString() + "px",  //(newY - 54).toString() + "px",
					//minHeight: (newY - 54).toString() + "px",
					// fix for issue 12 ( http://github.com/akzhan/jwysiwyg/issues/issue/12 )
					width: (newX > 50) ? (newX - 10).toString() + "px" : ""
			    });
		...
		this.ui.initFrame = function () {
		    ...
		    //AFV: hacking para arreglar el heiht del editor
			var toolbarheight = toolbarWrapEl.height();
			var marginTopDelEditor = parseInt(self.editor.css("margin-top").replace("px", ""));
			var marginBottomDelEditor = parseInt(self.editor.css("margin-bottom").replace("px", ""));
            // al height del editor le resto el height del toolbar y el margin-top y margin-bottom 
			self.editor.height(self.editor.height() - toolbarheight - (marginTopDelEditor + marginBottomDelEditor + 3));
            //AFV: fin del hacking
